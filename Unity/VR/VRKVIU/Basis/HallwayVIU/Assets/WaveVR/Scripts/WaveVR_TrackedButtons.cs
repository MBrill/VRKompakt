...
[System.Obsolete("WaveVR_TrackedButtons is deprecated. Please use WaveVR_Controller or WaveVRPlayer instead.")]
public class WaveVR_TrackedButtons : MonoBehaviour
{
	...
	private bool hmdEnterPressed = false;
	...
	{
		Log.i (LOG_TAG, "OnHmdEnterClicked!");
		if (HmdEnterClicked != null)
			HmdEnterClicked (this, e);
	}

	public virtual void OnHmdEnterUnclicked(ClickedEventArgs e)
	{
		Log.i (LOG_TAG, "OnHmdEnterUnclicked!");
		if (HmdEnterUnclicked != null)
			HmdEnterUnclicked (this, e);
	}
