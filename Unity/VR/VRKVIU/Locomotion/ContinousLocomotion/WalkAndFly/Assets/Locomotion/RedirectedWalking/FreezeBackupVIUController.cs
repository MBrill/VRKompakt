...
/// <summary>
///  VIU-Interface fü rFreezeBackup in RDW
/// </summary>
public class FreezeBackupVIUController : FreezeBackup
{
    ...
    public ControllerButton BackupButton = ControllerButton.Trigger;
    ...
    {
        ViveInput.AddListenerEx(Hand, BackupButton, 
    ...
    {
        ViveInput.RemoveListenerEx(Hand, BackupButton, 
            ButtonEventType.Down,  
            m_Trigger);
    }
