...
/// <summary>
/// Highlighter2 für ein GameObject,
...
///
///  Diese Version wird nicht verwendet, wird jedoch in
/// der Mustelösung besprochen als Alternative zur Verwendung
/// eines Input Assets.
/// </summary>
public class Highlighter2 : MonoBehaviour
{
    ...
    /// </summary>
    private void HighlightOn(InputAction.CallbackContext ctx) => myMaterial.color = highlightColor;

    /// <summary>
    /// Callback, falls die Taste wieder losgelassen wird.
    /// </summary>
    private void HighlightOff(InputAction.CallbackContext ctx) => myMaterial.color = originalColor;
}
