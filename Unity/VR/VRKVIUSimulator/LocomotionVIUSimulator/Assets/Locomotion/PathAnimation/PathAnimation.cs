...
/// </summary>
/// <remarks>
/// Wir repräsentieren die Kurve mit Hilfe von Wegpunkten, die wir
/// mit der Klasse WaypointManager verwalten.
/// </remarks>
public abstract class PathAnimation : MonoBehaviour
{
    [Header("Path Animation")]
        ...
        /// <summary>
        /// Periodisches Verhalten beim Ablaufen der Wegpunkte?
        /// </summary>
        ...
        /// </summary>
        /// <returns>Minimaler Abstand, ab dem ein Wegpunkt als erreicht
        /// gilt.
        /// </returns>
